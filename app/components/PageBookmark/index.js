...
const PageBookmark = () => (
  <Wrapper>
    <IconTab tabIndex="0" target="_blank" delay={0}></IconTab>
    ...
    <IconWrapper href="mailto:jsson77@gmail.com?subject=John Son - Software Engineer&body=Hi John," tabIndex="0" delay={400}>
      <SocialIcon className="far fa-envelope" />
    </IconWrapper>
    <IconWrapper href="" tabIndex="0" delay={200}>
