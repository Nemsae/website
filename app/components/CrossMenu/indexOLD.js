...
export class CrossMenu extends React.PureComponent {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    if (nextProps.active !== this.props.active) console.log('SCU    active changed!');
    if (nextProps.captureHoveredLocation !== this.props.captureHoveredLocation) console.log('SCU    captureHoveredLocation changed!');
    if (nextProps.resetHoveredLocation !== this.props.resetHoveredLocation) console.log('SCU    resetHoveredLocation changed!');
